...
- [ ] **Uitleg per sectie** (DM/SP) — naast de sectiekoppen van een kaartje staat een boekje: bij aanmaken, bewerken én bekijken. Rollen, Flavour, Geheimen, Gebied, Wie hoort hier bij, Koppelingen, Kaart, Statblock, Tiers, Adoptie, Winkel, Beeld en Aantekeningen. De DM kan elke tekst aanpassen via *Bewerken* in het venster; per tekst is er ook een herstelknop
