...
- [ ] **Eigen spreuk schrijven** (DM) — Spreuken → +: vul minstens een naam in, kies niveau en school, vink componenten/klassen aan en sla op. De spreuk staat tussen de rest met een tag *Eigen*, is doorzoekbaar, en een speler met die klasse ziet hem onder *Alleen mijn klasse*. Bewerken en verwijderen kan vanuit het spreukdetail; verwijderen laat de kopie in het boek van een speler staan
...
- [ ] **Schoolfilter bij spreuken** (ALL) — onder de niveaus staat een rij scholen met hun eigen icoon en kleur; klik *Necromancy* en alleen die spreuken blijven staan. *Alle scholen* zet het terug
