...
- [ ] **De onthulling wist niets** (DM) — onthul zelf geheim 2 van een kaartje en laat de party daarna datzelfde kaartje onderzoeken: na de wachttijd staan er **twee** regels open, niet één. *Dit was stuk:* het gereedmaken van het dossier zette de hele stand op één regel (`= { id: true }`), dus alles wat de party al wist ging weer dicht — en het onthulde blind de eerste regel, terwijl het rapport een andere kon bevatten.
