...
- [ ] **Inzoomen bij het plaatsen** (DM) — met − en + tot 600%; ingezoomd schuif je in het doek rond en blijft een klik op dezelfde plek uitkomen. Na het zoomen staat de speld weer in beeld
- [ ] **Kaart en Dungeon als eigen tabblad** (DM) — een locatiekaartje heeft in de editor de tabbladen *Kaart* en *Dungeon*; in het detailvenster verschijnen ze alleen als er ook echt een speld of een plattegrond aan hangt
