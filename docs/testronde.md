...
- [ ] **Uitleg per tabblad** (DM/SP) — rechts in de tabbalk van een kaartje staat één boekje, dat meeloopt met het open tabblad — bij aanmaken, bewerken én bekijken dezelfde tekst. De uitleg heeft doorklikstappen die het hele tabblad afgaan. Staat er voor een tabblad niets, dan staat er ook geen knop
