...
- [ ] **Speld zetten vanaf het kaartje** (DM) — in de editor, sectie *Op de kaart*: kies een kaart, klik in het beeld en de speld staat er. Nog eens klikken verplaatst hem, *Van de kaart halen* wist hem. Controleer op het Kaart-tabblad dat hij op dezelfde plek staat
...
- [ ] **Op de kaart in het detailvenster** (DM/SP) — een locatie met een speld toont onder de beschrijving een uitsnede van de kaart met de speld erop, plus *Toon op de hele kaart*. Zonder speld staat het blok er niet. Die knop sluit het venster en springt naar de kaart (deed eerder zichtbaar niets)
...
- [ ] **Melding bij een type met extra's** (DM) — kies Winkel, Herberg of Tempel: onder de keuzelijst staat wat dat oplevert, met een link naar *Koppelingen* die ernaartoe springt en de sectie kort laat oplichten. Bij andere types staat er niets
...
- [ ] **Herberg en Tempel dubbel in de lijst** (DM) — die twee (en Winkel) staan zowel onder *Kan aan een dienst hangen* als onder *Gebouw*: het type zegt wat voor pand het is, niet dat het aan de dienst hangt. Drie herbergen kiezen kan dus, terwijl er maar één de dienst is
