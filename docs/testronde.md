...
- [ ] **Naam in de kop van de editor** (DM) — bovenaan staat *Locatie bewerken › De Swarte Cat*; tik je in het naamveld een andere naam, dan loopt de kop mee. Bij een nieuw kaartje staat er alleen *Nieuwe locatie*
- [ ] **Twee rollen op dezelfde plek** (DM) — zet bij *Wat hoort hier bij?* dezelfde locatie twee keer neer, één keer als Eigenaar en één keer als Verkoper: na opslaan staan ze er allebei nog, en op dat kaartje staan ze allebei bij *Wie hoort hier bij?*. Tik je twee keer exact dezelfde rol in, dan blijft er één over
