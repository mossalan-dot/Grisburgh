...
- [ ] **Standaard statblok invullen** (DM) — bewerk een personage, tab Statblock: bovenaan staat *Standaard statblok*. Typ *Guard* en klik Invullen: AC 16, HP 11 (2d8 + 2), Size "Small or Medium", de ability-modifiers eronder kloppen, en bij Actions staat de Spear. Stond er al iets, dan vraagt hij eerst om bevestiging
