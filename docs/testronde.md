...
- [ ] **Geheime antagonist per geheim** (DM) — vink bij één van twee geheimen "Onthullen maakt het personage een vijand" aan; dat geheim onthullen geeft hem de badge én zet zijn kant op vijand, het andere geheim doet niets; terugdraaien haalt de badge weg en zet zijn oude kant én alignment terug. Alignment schuift bij het onthullen naar Evil met behoud van de as: Neutral Good → Neutral Evil, Lawful Neutral → Lawful Evil; Unaligned blijft
