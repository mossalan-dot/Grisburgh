...
const BRONNEN = ['spells-2024', 'hp-spells', 'extra-spells', 'feature-descriptions', 'backgrounds-2024', 'volken-klassen', 'srd-monsters', 'srd-items', 'feats-2024'];
...
function bronVoor(naam, { volledig, eigen = {} } = {}) {
  ...
  // Zelfde verhaal voor de standaard-uitrusting: 333 voorwerpen uit de SRD 5.2,
  // dus CC BY 4.0 en compleet mee naar elke campagne.
  if (naam === 'srd-items') return data;
