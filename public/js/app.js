import { api, campagneUitUrl, zetCampagne } from './api.js?v=294';
...
import { initDmPanel } from "./dm-panel.js?v=289";
    ...
    return `
      <div class="ts-event${isAfgerond ? ' ts-event--afgerond' : ''}">
        <div class="ts-event-head">
          <span class="ts-event-type">${icon('dice')} ${esc(event.soort || 'Weddenschap')}</span>
