...
function renderDashCard(e) {
  ...
  return `
    <div class="bg-room-surface border border-room-border rounded-lg cursor-pointer hover:-translate-y-0.5 hover:shadow-deep hover:border-room-border-light transition"
      ...
      <img class="w-full h-28 object-cover rounded-t-lg" src="${api.thumbForEntity(e)}"
...
window._openDashDetail = async (panel, id) => {
  ...
  // Image
  body += `<div class="mb-4"><img src="${api.thumbForEntity(e)}" class="w-full max-h-64 object-contain rounded" onerror="this.parentElement.style.display='none'"></div>`;
