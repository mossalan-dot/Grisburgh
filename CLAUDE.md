...
```
index.html  : theme.css?v=384   app.js?v=531   sound-manager.js?v=8
app.js      : api.js?v=244      render-campagne.js?v=117   render-archief.js?v=65
              ...
              dm-panel.js?v=141    render-dashboard.js?v=5
              render-spreuken.js?v=8   media-picker.js?v=3
dm-panel.js : combat-canvas.js?v=15   render-statblock.js?v=3
```
