...
```
index.html  : theme.css?v=376   app.js?v=509   sound-manager.js?v=5
app.js      : api.js?v=238      render-campagne.js?v=115   render-archief.js?v=57
              ...
              dm-panel.js?v=122    render-dashboard.js?v=3
