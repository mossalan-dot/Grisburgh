...
```
index.html  : theme.css?v=385   app.js?v=533   sound-manager.js?v=8
app.js      : api.js?v=244      render-campagne.js?v=117   render-archief.js?v=65
              ...
              dm-panel.js?v=143    render-dashboard.js?v=5
              render-spreuken.js?v=8   media-picker.js?v=3
dm-panel.js : combat-canvas.js?v=17   render-statblock.js?v=3
```
