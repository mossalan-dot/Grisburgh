...
```
index.html  : theme.css?v=306   app.js?v=440   sound-manager.js?v=5
app.js      : api.js?v=238      render-campagne.js?v=98   render-archief.js?v=45
              ...
              dm-panel.js?v=95    render-dashboard.js?v=3
