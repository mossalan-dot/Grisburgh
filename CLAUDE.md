...
```
index.html  : theme.css?v=417   app.js?v=575   sound-manager.js?v=8
app.js      : api.js?v=259      render-campagne.js?v=127   render-archief.js?v=75
              ...
              dm-panel.js?v=178    render-dashboard.js?v=9
