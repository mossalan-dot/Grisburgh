...
```
index.html  : theme.css?v=367   app.js?v=497   sound-manager.js?v=5
app.js      : api.js?v=238      render-campagne.js?v=113   render-archief.js?v=54
              ...
              dm-panel.js?v=116    render-dashboard.js?v=3
