...
```
index.html  : theme.css?v=495   app.js?v=592   sound-manager.js?v=8
app.js      : api.js?v=271      render-campagne.js?v=142   render-archief.js?v=76
              ...
              dm-panel.js?v=206    render-dashboard.js?v=9
