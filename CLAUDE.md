...
```
index.html  : theme.css?v=245   app.js?v=343   sound-manager.js?v=4
app.js      : api.js?v=225      render-campagne.js?v=89   render-archief.js?v=35
              render-kaart.js?v=4  render-dungeon.js?v=19  render-relatiemap.js?v=11
              render-progressie.js?v=22  socket-client.js?v=27
              render-bestiarium.js?v=7  render-statblock.js?v=3
              dm-panel.js?v=66
