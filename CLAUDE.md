...
```
index.html  : theme.css?v=430   app.js?v=586   sound-manager.js?v=8
app.js      : api.js?v=262      render-campagne.js?v=128   render-archief.js?v=75
              ...
              dm-panel.js?v=194    render-dashboard.js?v=9
