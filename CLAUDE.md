...
```
index.html  : theme.css?v=371   app.js?v=504   sound-manager.js?v=5
app.js      : api.js?v=238      render-campagne.js?v=115   render-archief.js?v=56
              ...
              dm-panel.js?v=119    render-dashboard.js?v=3
